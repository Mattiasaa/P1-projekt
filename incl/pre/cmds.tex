...
\newcommand{\slut}{\textrm{slut}}	% slut i normal tekst
\newcommand{\dist}{\textrm{dist}}	% dist i normal tekst
\newcommand{\goal}{\textrm{goal}}	% goal i normal tekst
\DeclareMathAlphabet{\pazocal}{OMS}{zplm}{m}{n} %\pazocal{P} laver nu fanzy/ik-fanzy P.
\DeclareMathAlphabet      {\mathbfit}{OML}{cmm}{b}{it} %bold italic math
