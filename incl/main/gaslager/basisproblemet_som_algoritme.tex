...
Derefter opstiller vi en repræsentation for grafen. Dette gør vi ved at lave en funktion, der danner en \emph{dictionary}!!!!!!!!!!!!!, %en ordbog, en associationsliste hvor nogle værdier, i vores tilfælde knuder, bruges til at.
 med alle nabolister. Først er vi dog nødt til at lave en funktion, som kan tilføje kanterne, da vi skal bruge denne i funktionen:
