...
Til allersidst tilføjer den en kant mellem '$\textrm{q\_slut}$' og $'\textrm{q12.0}'$ med vægt $0$, dette skyldes, at vores kode for dijkstras ikke kan finde længden til et punkt, som ikke har sin egen dictionary.
