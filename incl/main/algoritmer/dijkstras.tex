...
Dijkstras algoritme finder distancen af den korteste vej mellem to knuder, $a$ og $z$, i en vægtet, simpel graf, sådan at $L(z)=\alpha(a,z)$, hvis alle kantvægtene er ikke-negative og der eksisterer en sådan vej. 
\end{thm}
