...
\begin{center}
	\begin{tabular}{ |p{4cm}||p{3cm}|}
		...
		G &  \\
 	\hline
 	\label{tab:Nabo-liste onabo}
	\end{tabular}
\end{center}

\ref{tab:Nabo-liste onabo} viser knuder over nabo knuderne over den orienteret graf \ref{fig:onabo}. kigger man på knuderne B og F kan man se der er paralle kanter, da kanterne er orienteret i hver deres retning. Kigger man på knuderne A og G kan man ikke se der er paralle linjer mellem A og G, da begge kanter er orienteret fra A til G
