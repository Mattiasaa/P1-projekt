...
%% Vertices
    	...
    	\node[enclosed, label={below: $q_{1,1}$}]   (v3) at  (2,2)  {};
     	...
     	\node[enclosed, label={below: $q_{2,1}$}]   (v5) at  (4,2)  {};
     	\node[enclosed, label={below: $q_{2,2}$}]   (v6) at  (4,4)  {};
     	\node[enclosed, label={above: $q_{2,3}$}]   (v7) at  (4,6)  {};
     	\node[enclosed, label={below: $q_{3,1}$}]   (v8) at  (6,2)  {};
     	\node[enclosed, label={below: $q_{3,2}$}]   (v9) at  (6,4)  {};
     	\node[enclosed, label={above: $q_{3,3}$}]   (v10) at (6,6)  {};
...
%Edges
	...
	\end{tikzpicture}
	\caption{Forsimplet, udvidet graf.}
