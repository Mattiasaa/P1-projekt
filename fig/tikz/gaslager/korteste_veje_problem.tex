...
%Edges
		\path[->,>=latex,thick] (v1) edge node[midway, sloped, above, label={below, black: $10$}] {} (v2);
		\path[->,>=latex,thick] (v1) edge node[midway, sloped, below, label={above: $30$ }] {} (v3);
		\path[red,->,>=latex,ultra thick] (v1) edge node[midway, sloped, below, label={above, black: $50$ }] {} (v4);
		...
		\path[red,->,>=latex,ultra thick] (v4) edge node[near end, sloped, below, label={above, black: $8$ }] {} (v6);
		...
		\path[red,->,>=latex,ultra thick] (v6) edge node[near end, sloped, below, label={above,black: $5$ }] {} (v8);
		...
		\path[red,->,>=latex,ultra thick] (v8) edge node[midway, sloped, above, label={below,black: $30$ }] {} (v11);
		...
		\path[red,->,>=latex,ultra thick] (v11) edge node[midway, sloped, above, label={below,black: $30$ }] {} (v14);
		\path[red,->,>=latex,ultra thick] (v11) edge node[midway, above, label={above,black: $45$ }] {} (v15);
		...
		\path[red,->,>=latex,ultra thick] (v14) edge node[midway, sloped, above, label={below,black: $30$ }] {} (v17);
		\path[red,->,>=latex,ultra thick] (v14) edge node[midway, above, label={above,black: $45$ }] {} (v18);
		...
		\path[red,->,>=latex,ultra thick] (v15) edge node[midway, above, label={above,black: $45$ }] {} (v19);
		...
		\path[red,->,>=latex,ultra thick] (v17) edge node[midway, sloped, above, label={below,black: $30$ }] {} (v20);
		\path[red,->,>=latex,ultra thick] (v18) edge node[midway, sloped, above, label={below,black: $15$ }] {} (v20);
		\path[red,->,>=latex,ultra thick] (v19) edge node[midway, sloped, below, label={above,black: $0$ }] {} (v20);
	\end{tikzpicture}
