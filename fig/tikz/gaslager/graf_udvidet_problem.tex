...
%Edges
		...
		\path[->,>=latex,thick] (v4) edge node[near end, sloped, below, label={above, black: $22$ }] {} (v6);
		...
		\path[->,>=latex,thick] (v8) edge node[midway, sloped, above, label={below,black: $0$ }] {} (v11);
		...
		\path[->,>=latex,thick] (v18) edge node[midway, sloped, above, label={below,black: $15$ }] {} (v20);
		\path[->,>=latex,thick] (v19) edge node[midway, sloped, below, label={above,black: $30$ }] {} (v20);
	\end{tikzpicture}
